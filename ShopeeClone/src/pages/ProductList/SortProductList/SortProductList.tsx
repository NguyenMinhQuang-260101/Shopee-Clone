    ...
    <div className='bg-gray-300/40 py-4 px-3'>
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex items-center flex-wrap gap-2'>
          ...
          <button className='text-white h-8 px-4 bg-orange text-sm hover:bg-orange/80 text-center '>Phổ biến</button>
          <button className='text-black h-8 px-4 bg-white text-sm hover:bg-slate-100 text-center '>Mới nhất</button>
